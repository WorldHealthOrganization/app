...
class Void extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'Void', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'who'), createEmptyInstance: create)
...
class PutClientSettingsRequest extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'PutClientSettingsRequest', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'who'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'token')
    ..aOS(12, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'isoCountryCode', protoName: 'isoCountryCode')
    ..hasRequiredFields = false
  ;
  ...
  factory PutClientSettingsRequest.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(i, r);
  factory PutClientSettingsRequest.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(i, r);
  @$core.Deprecated(
  'Using this can add significant overhead to your binary. '
  'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
  'Will be removed in next major version')
  PutClientSettingsRequest clone() => PutClientSettingsRequest()..mergeFromMessage(this);
  @$core.Deprecated(
  'Using this can add significant overhead to your binary. '
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  PutClientSettingsRequest copyWith(void Function(PutClientSettingsRequest) updates) => super.copyWith((message) => updates(message as PutClientSettingsRequest)) as PutClientSettingsRequest; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  static PutClientSettingsRequest create() => PutClientSettingsRequest._();
  PutClientSettingsRequest createEmptyInstance() => create();
  static $pb.PbList<PutClientSettingsRequest> createRepeated() => $pb.PbList<PutClientSettingsRequest>();
  @$core.pragma('dart2js:noInline')
  static PutClientSettingsRequest getDefault() => _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<PutClientSettingsRequest>(create);
...
class JurisdictionId extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'JurisdictionId', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'who'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'code')
    ..e<JurisdictionType>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'jurisdictionType', $pb.PbFieldType.OE, protoName: 'jurisdictionType', defaultOrMaker: JurisdictionType.GLOBAL, valueOf: JurisdictionType.valueOf, enumValues: JurisdictionType.values)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  JurisdictionId copyWith(void Function(JurisdictionId) updates) => super.copyWith((message) => updates(message as JurisdictionId)) as JurisdictionId; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class GetCaseStatsRequest extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'GetCaseStatsRequest', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'who'), createEmptyInstance: create)
    ..pc<JurisdictionId>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'jurisdictions', $pb.PbFieldType.PM, subBuilder: JurisdictionId.create)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  GetCaseStatsRequest copyWith(void Function(GetCaseStatsRequest) updates) => super.copyWith((message) => updates(message as GetCaseStatsRequest)) as GetCaseStatsRequest; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class GetCaseStatsResponse extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'GetCaseStatsResponse', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'who'), createEmptyInstance: create)
    ..aOM<CaseStats>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'globalStats', protoName: 'globalStats', subBuilder: CaseStats.create)
    ...
    ..pc<CaseStats>(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'jurisdictionStats', $pb.PbFieldType.PM, protoName: 'jurisdictionStats', subBuilder: CaseStats.create)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  GetCaseStatsResponse copyWith(void Function(GetCaseStatsResponse) updates) => super.copyWith((message) => updates(message as GetCaseStatsResponse)) as GetCaseStatsResponse; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class StatSnapshot extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'StatSnapshot', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'who'), createEmptyInstance: create)
    ..a<$fixnum.Int64>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'epochMsec', $pb.PbFieldType.OU6, protoName: 'epochMsec', defaultOrMaker: $fixnum.Int64.ZERO)
    ..aInt64(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'dailyCases', protoName: 'dailyCases')
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  StatSnapshot copyWith(void Function(StatSnapshot) updates) => super.copyWith((message) => updates(message as StatSnapshot)) as StatSnapshot; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class CaseStats extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'CaseStats', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'who'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'jurisdiction')
    ..a<$fixnum.Int64>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'lastUpdated', $pb.PbFieldType.OU6, protoName: 'lastUpdated', defaultOrMaker: $fixnum.Int64.ZERO)
    ..aInt64(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'cases')
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  CaseStats copyWith(void Function(CaseStats) updates) => super.copyWith((message) => updates(message as CaseStats)) as CaseStats; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class WhoServiceApi {
  ...
  $async.Future<Void> putClientSettings($pb.ClientContext ctx, PutClientSettingsRequest request) {
    var emptyResponse = Void();
    return _client.invoke<Void>(ctx, 'WhoService', 'putClientSettings', request, emptyResponse);
  }
