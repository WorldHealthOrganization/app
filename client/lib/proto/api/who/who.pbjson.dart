...
final $typed_data.Uint8List jurisdictionTypeDescriptor = $convert.base64Decode('ChBKdXJpc2RpY3Rpb25UeXBlEgoKBkdMT0JBTBAAEg4KCldIT19SRUdJT04QARILCgdDT1VOVFJZEAI=');
...
final $typed_data.Uint8List platformDescriptor = $convert.base64Decode('CghQbGF0Zm9ybRIHCgNJT1MQABILCgdBTkRST0lEEAESBwoDV0VCEAI=');
...
final $typed_data.Uint8List putClientSettingsRequestDescriptor = $convert.base64Decode('ChhQdXRDbGllbnRTZXR0aW5nc1JlcXVlc3QSFAoFdG9rZW4YASABKAlSBXRva2VuEiYKDmlzb0NvdW50cnlDb2RlGAwgASgJUg5pc29Db3VudHJ5Q29kZQ==');
...
final $typed_data.Uint8List jurisdictionIdDescriptor = $convert.base64Decode('Cg5KdXJpc2RpY3Rpb25JZBJBChBqdXJpc2RpY3Rpb25UeXBlGAIgASgOMhUud2hvLkp1cmlzZGljdGlvblR5cGVSEGp1cmlzZGljdGlvblR5cGUSEgoEY29kZRgBIAEoCVIEY29kZQ==');
...
final $typed_data.Uint8List getCaseStatsRequestDescriptor = $convert.base64Decode('ChNHZXRDYXNlU3RhdHNSZXF1ZXN0EjkKDWp1cmlzZGljdGlvbnMYASADKAsyEy53aG8uSnVyaXNkaWN0aW9uSWRSDWp1cmlzZGljdGlvbnM=');
...
final $typed_data.Uint8List getCaseStatsResponseDescriptor = $convert.base64Decode('ChRHZXRDYXNlU3RhdHNSZXNwb25zZRI0CgtnbG9iYWxTdGF0cxgBIAEoCzIOLndoby5DYXNlU3RhdHNCAhgBUgtnbG9iYWxTdGF0cxI8ChFqdXJpc2RpY3Rpb25TdGF0cxgDIAMoCzIOLndoby5DYXNlU3RhdHNSEWp1cmlzZGljdGlvblN0YXRzEhAKA3R0bBgCIAEoBFIDdHRs');
...
final $typed_data.Uint8List statSnapshotDescriptor = $convert.base64Decode('');
...
final $typed_data.Uint8List caseStatsDescriptor = $convert.base64Decode('');
const $core.Map<$core.String, $core.dynamic> WhoServiceBase$json = const {
  '1': 'WhoService',
  '2': const [
    const {'1': 'putClientSettings', '2': '.who.PutClientSettingsRequest', '3': '.who.Void'},
...
const $core.Map<$core.String, $core.Map<$core.String, $core.dynamic>> WhoServiceBase$messageJson = const {
...
final $typed_data.Uint8List whoServiceDescriptor = $convert.base64Decode('CgpXaG9TZXJ2aWNlEj0KEXB1dENsaWVudFNldHRpbmdzEh0ud2hvLlB1dENsaWVudFNldHRpbmdzUmVxdWVzdBoJLndoby5Wb2lkEkMKDGdldENhc2VTdGF0cxIYLndoby5HZXRDYXNlU3RhdHNSZXF1ZXN0Ghkud2hvLkdldENhc2VTdGF0c1Jlc3BvbnNl');
