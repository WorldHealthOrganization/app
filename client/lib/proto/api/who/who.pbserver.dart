...
abstract class WhoServiceBase extends $pb.GeneratedService {
  ...
  $async.Future<$pb.GeneratedMessage> handleCall($pb.ServerContext ctx, $core.String method, $pb.GeneratedMessage request) {
    switch (method) {
      case 'putClientSettings': return this.putClientSettings(ctx, request as $0.PutClientSettingsRequest);
      case 'getCaseStats': return this.getCaseStats(ctx, request as $0.GetCaseStatsRequest);
      default: throw $core.ArgumentError('Unknown method: $method');
    }
  }
