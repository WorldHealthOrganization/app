...
class WhoCacheManager extends CacheManager {
  ...
  WhoCacheManager._init()
      : super(Config(
          key,
          stalePeriod: const Duration(days: 5000),
  ...
  Future<File> getSingleFile(String url,
    ...
    try {
      ...
      final download =
          await webHelper.downloadFile(url, authHeaders: headers!).drain();
      return download.file;
    } catch (e) {
      var error = 'Error downloading file: $url, $e';
