...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static m0(copyrightString, versionString) => "${copyrightString} \n\n${versionString} \nBuilt by the WHO COVID-19 App Collective.";
  ...
  static _notInlinedMessages(_) => <String, Function> {
    ...
    "aboutPagePrivacyPolicyLinkText" : MessageLookupByLibrary.simpleMessage("Privacy Policy"),
    "aboutPagePrivacyPolicyLinkUrl" : MessageLookupByLibrary.simpleMessage("https://www.who.int/myhealthapp/privacy-notice"),
    "aboutPageTermsOfServiceLinkText" : MessageLookupByLibrary.simpleMessage("Terms of Service"),
    ...
    "aboutPageViewLicensesLinkText" : MessageLookupByLibrary.simpleMessage("View Licenses"),
    "checkUpIntroPageByUsingThisToolYouAgreeToItsTermsAnd" : MessageLookupByLibrary.simpleMessage("By using this tool, you agree to its terms and that WHO will not be liable for any harm relating to your use."),
    "checkUpIntroPageCheckup" : MessageLookupByLibrary.simpleMessage("Check-Up"),
    "checkUpIntroPageGetStarted" : MessageLookupByLibrary.simpleMessage("Get Started"),
    "checkUpIntroPageNotMedicalAdvise" : MessageLookupByLibrary.simpleMessage("Information provided by this tool does not constitute medical advise and should not be used to diagnose or treat medical conditions."),
    "checkUpIntroPageSeeTerms" : MessageLookupByLibrary.simpleMessage("See terms ›"),
    "checkUpIntroPageYouShouldKnow" : MessageLookupByLibrary.simpleMessage("You should know..."),
    "checkUpIntroPageYourAnswersWillNotBeSharedWithWhoOrOthers" : MessageLookupByLibrary.simpleMessage("Your answers will not be shared with WHO or others without your permission."),
    "commonContentLoadingDialogUpdateRequiredBodyText" : MessageLookupByLibrary.simpleMessage("Please update to the latest version of the app in order to receive the latest information and updates."),
    "commonContentLoadingDialogUpdateRequiredDetails" : MessageLookupByLibrary.simpleMessage("This information may be outdated. You must update this app to receive more recent COVID-19 info."),
    ...
    "commonWhoAppShareIconButtonDescription" : MessageLookupByLibrary.simpleMessage("Check out the official COVID-19 app from the World Health Organization https://covid19app.who.int/app"),
    ...
    "countrySelectCountryLabel" : MessageLookupByLibrary.simpleMessage("Country"),
    "countrySelectPlaceholder" : MessageLookupByLibrary.simpleMessage("Select"),
    "healthCheckTitle" : MessageLookupByLibrary.simpleMessage("Health Check"),
    "homePageCountryTotalCases" : m5,
    "homePageCovid19Response" : MessageLookupByLibrary.simpleMessage("COVID-19 Response"),
    "homePageGlobalTotalCases" : MessageLookupByLibrary.simpleMessage("Global Total Cases"),
    ...
    "homePagePageButtonWHOMythBusters" : MessageLookupByLibrary.simpleMessage("Get the Facts"),
    "homePagePageButtonWHOMythBustersDescription" : MessageLookupByLibrary.simpleMessage("Learn the facts about COVID-19 and how to prevent the spread"),
    "homePagePageButtonYourQuestionsAnswered" : MessageLookupByLibrary.simpleMessage("Questions & Answers"),
    "homePagePageDonate" : MessageLookupByLibrary.simpleMessage("Donate Here"),
    ...
    "homePagePageSliverListSettingsHeader1" : MessageLookupByLibrary.simpleMessage("Analytics"),
    ...
    "homePagePageSliverListSettingsNotificationsInfo" : MessageLookupByLibrary.simpleMessage("Allow WHO to send you notifications to inform you of updates"),
    ...
    "homePagePageSupport" : MessageLookupByLibrary.simpleMessage("Help support the relief effort"),
    "homePagePageTitle" : MessageLookupByLibrary.simpleMessage("COVID-19"),
    "latestNumbersPageCasesDimension" : MessageLookupByLibrary.simpleMessage("Global Cases"),
    "latestNumbersPageDaily" : MessageLookupByLibrary.simpleMessage("Daily"),
    "latestNumbersPageDailyToggle" : MessageLookupByLibrary.simpleMessage("New"),
    "latestNumbersPageDeathsDimension" : MessageLookupByLibrary.simpleMessage("Global Deaths"),
    "latestNumbersPageDisclosure" : MessageLookupByLibrary.simpleMessage("Data may be incomplete for the current day or week."),
    ...
    "latestNumbersPageTitle" : MessageLookupByLibrary.simpleMessage("Recent Numbers"),
    ...
    "legalLandingPagePrivacyPolicyLinkText" : MessageLookupByLibrary.simpleMessage("Privacy Policy"),
    ...
    "legalLandingPageTitle" : MessageLookupByLibrary.simpleMessage("Official WHO COVID-19 Information App"),
    "locationSharingPageButton" : MessageLookupByLibrary.simpleMessage("Allow Location Sharing"),
    "locationSharingPageDescription" : MessageLookupByLibrary.simpleMessage("To get local news and information, select your home country."),
    "locationSharingPageTitle" : MessageLookupByLibrary.simpleMessage("Get the latest news from your community"),
    ...
    "newsFeedSliverListNewsFeedItemTitle1" : MessageLookupByLibrary.simpleMessage("Situation Reports"),
    "newsFeedSliverListNewsFeedItemTitle2" : MessageLookupByLibrary.simpleMessage("Rolling Updates"),
    "newsFeedSliverListNewsFeedItemTitle3" : MessageLookupByLibrary.simpleMessage("News Articles"),
    "newsFeedSliverListNewsFeedItemTitle4" : MessageLookupByLibrary.simpleMessage("Press Briefings"),
    ...
    "notificationsEnableDialogHeader" : MessageLookupByLibrary.simpleMessage("Enable notifications"),
    "notificationsEnableDialogOptionLater" : MessageLookupByLibrary.simpleMessage("Maybe later"),
    "notificationsEnableDialogOptionOpenSettings" : MessageLookupByLibrary.simpleMessage("Open Settings"),
    "notificationsEnableDialogText" : MessageLookupByLibrary.simpleMessage("As you\'ve previously disabled notifications, we\'ll need you to manually re-enable notifications via the system settings for the app"),
    ...
    "protectYourselfListOfItemsPageListItem1" : MessageLookupByLibrary.simpleMessage("*Wash your hands* with soap and water to avoid getting sick and spreading infections to others"),
    ...
    "protectYourselfListOfItemsPageListItem4" : MessageLookupByLibrary.simpleMessage("*Stay more than* 1 meter (>3 feet) away from a person who is sick"),
    "protectYourselfListOfItemsPageListItem5" : MessageLookupByLibrary.simpleMessage("Only wear a mask if you or someone you are looking after are ill with COVID-19 symptoms (especially coughing)"),
    "protectYourselfTitle" : MessageLookupByLibrary.simpleMessage("Protect Yourself"),
    "travelAdviceContainerText" : MessageLookupByLibrary.simpleMessage("<p>WHO continues to <b>advise against the application of travel or trade restrictions</b> to countries experiencing COVID-19 outbreaks.</p> <p><b>It is prudent for travellers who are sick to delay or avoid travel to affected areas</b>, in particular for elderly travellers and people with chronic diseases or underlying health conditions. “Affected areas” are considered those countries, provinces, territories or cities experiencing ongoing transmission of COVID-19, in contract to areas reporting only imported cases.</p>"),
    "travelAdvicePageButtonGeneralRecommendations" : MessageLookupByLibrary.simpleMessage("General Recommendations"),
