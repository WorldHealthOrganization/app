...
class HomePage extends StatefulWidget {
  ...
  HomePage(this.analytics, this.locale);
  @override
...
class _HomePageState extends State<HomePage> {
  ...
  _getUserLangPref() async {
    var _langPrefString =  await UserPreferences().getUserPrefLanguage();
    _langPrefString == null
      ? await S.delegate.load(locale)
      : await S.delegate.load(
        Locale(_langPrefString.split('_').first, _langPrefString.split('_').last));
    setState(() {});
  }
