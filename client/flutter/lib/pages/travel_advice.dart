...
class TravelAdvice extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return CarouselView([
      ...
      CarouselSlide(context, message: "General recommendations for all travellers include…"),
      CarouselSlide(context, titleWidget: EmojiHeader("🧼"), message: "Wash your hands frequently"),
      CarouselSlide(context,
      ...
      CarouselSlide(context,
          titleWidget: EmojiHeader("🍗"), message: "Follow proper food hygiene practices"),
      CarouselSlide(context,
          titleWidget: EmojiHeader("😷"),
          message:
