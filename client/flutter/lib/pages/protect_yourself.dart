...
class ProtectYourself extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return CarouselView([
      CarouselSlide(context, titleWidget: EmojiHeader("🧼"), message: S.of(context).washHands),
      CarouselSlide(context,
          titleWidget: EmojiHeader("👄"), message: "Avoid touching your eyes, mouth, and nose"),
      CarouselSlide(context,
          titleWidget: EmojiHeader("💪"),
          message:
              "Cover your mouth and nose with your bent elbow or tissue when you cough or sneeze"),
      CarouselSlide(context, titleWidget: EmojiHeader("🚷"), message: "Avoid crowded places"),
      CarouselSlide(context,
          titleWidget: EmojiHeader("🏠"),
      ...
      CarouselSlide(context,
          titleWidget: EmojiHeader("ℹ️"), message: "Stay aware of the latest information from WHO"),
    ]);
  }
}
