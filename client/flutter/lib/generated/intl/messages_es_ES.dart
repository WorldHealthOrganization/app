...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static _notInlinedMessages(_) => <String, Function> {
    "commonWhoAppShareIconButtonDescription" : MessageLookupByLibrary.simpleMessage("Consulte la aplicación oficial de guía COVID - 19 https://www.who.int/covid-19-app%27"),
    ...
    "onBoardingLocationSharingPageButtonAllow" : MessageLookupByLibrary.simpleMessage("Permitir compartir ubicación"),
    "onBoardingLocationSharingPageButtonSkip" : MessageLookupByLibrary.simpleMessage("Saltar"),
    ...
    "travelAdviceListOfItemsPageListItem12" : MessageLookupByLibrary.simpleMessage("Automonitoree los síntomas durante 14 días y siga los protocolos nacionales de los países receptores. Algunos países pueden requerir que los viajeros que regresan entren en cuarentena"),
    "travelAdviceListOfItemsPageListItem13" : MessageLookupByLibrary.simpleMessage("Los lectores térmicos PUEDEN detectar si la gente tiene fiebre pero no pueden detectar si alguien tiene coronavirus o no"),
    "travelAdviceListOfItemsPageListItem14" : MessageLookupByLibrary.simpleMessage("Si se producen síntomas, como fiebre, tos o dificultad para respirar, se aconseja a los viajeros que se pongan en contacto con los proveedores de atención médica locales, preferiblemente por teléfono, y que les informen de sus síntomas y de su historial de viaje."),
    "travelAdviceListOfItemsPageListItem2" : MessageLookupByLibrary.simpleMessage("Es prudente que los viajeros que están enfermos retrasen o eviten viajar a las zonas afectadas, en particular a los viajeros mayores y a las personas con enfermedades crónicas o condiciones de salud subyacentes…"),
    "travelAdviceListOfItemsPageListItem3" : MessageLookupByLibrary.simpleMessage("Se consideran “zonas afectadas” los países, provincias, territorios o ciudades que están siendo objeto de una transmisión continua del CÓVID-19, a diferencia de las zonas que sólo informan de casos importados…"),
    "travelAdviceListOfItemsPageListItem4" : MessageLookupByLibrary.simpleMessage("Las recomendaciones generales para todos los viajeros incluyen…"),
    "travelAdviceListOfItemsPageListItem5" : MessageLookupByLibrary.simpleMessage("Lavar las manos con frecuencia"),
    "travelAdviceListOfItemsPageListItem6" : MessageLookupByLibrary.simpleMessage("Evita tocar los ojos, la boca y la nariz"),
    "travelAdviceListOfItemsPageListItem7" : MessageLookupByLibrary.simpleMessage("Cubre la boca y la nariz con el codo o tejido doblado cuando tos o te escondes"),
    "travelAdviceListOfItemsPageListItem8" : MessageLookupByLibrary.simpleMessage("Manténgase a más de 1 metro (3 pies) de una persona enferma"),
    "travelAdviceListOfItemsPageListItem9" : MessageLookupByLibrary.simpleMessage("Siga las prácticas de higiene alimentaria adecuadas"),
