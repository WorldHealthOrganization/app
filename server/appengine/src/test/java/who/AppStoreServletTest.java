...
public class AppStoreServletTest {
    private static final String SAMPLE_ANDROID_USER_AGENT = "Mozilla/5.0 (Linux; U; Android 2.2) AppleWebKit/533.1 (KHTML, like Gecko) Version/4.0 Mobile Safari/533.1";
    private static final String SAMPLE_IOS_USER_AGENT = "Mozilla/5.0 (iPhone; CPU iPhone OS 12_2 like Mac OS X) AppleWebKit/605.1.15 (KHTML, like Gecko) Mobile/15E148";
    ...
    public void testAndroidAppStoreLink() throws Exception {
        ...
        assertEquals(stringCaptor.getValue(), AppStoreServlet.GOOGLE_PLAY_STORE_LINK);
    }
